...
public class WeatherForecastRepository {
    ...
    public String[] fetch() {
        String forecastJsonString = getForecastJsonString();
    ...
    @Nullable
    private String getForecastJsonString() {
        ...
        try {
            forecastJsonStr = getWeatherJsonString(urlConnection, reader);
        } catch (IOException e) {
            Log.e(LOG_TAG, "Error ", e);
    ...
    private String getWeatherJsonString(HttpURLConnection urlConnection, BufferedReader reader) throws IOException {
