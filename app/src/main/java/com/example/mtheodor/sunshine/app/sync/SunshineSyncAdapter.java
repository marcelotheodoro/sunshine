package com.example.mtheodor.sunshine.app.sync;
...
import com.example.mtheodor.sunshine.app.Configuration;
import com.example.mtheodor.sunshine.app.MainActivity;
import com.example.mtheodor.sunshine.app.R;
import com.example.mtheodor.sunshine.app.Utility;
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(APPID_PARAM, Configuration.OPEN_WEATHER_API_KEY)
                    .build();

            String apiUrl = builtUri.toString();
